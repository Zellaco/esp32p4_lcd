...
const jd9365_lcd_init_cmd_t esp32p4_4d_init_cmds[] = {
...
#elif defined(CONFIG_ESP32P4_LCD_80)
    {0xE0, (uint8_t[]){0x00}, 1, 0},
    {0xE1, (uint8_t[]){0x93}, 1, 0},
    {0xE2, (uint8_t[]){0x65}, 1, 0},
    {0xE3, (uint8_t[]){0xF8}, 1, 0},
	...
	{0x5D, (uint8_t[]){0x70}, 1, 0},
	{0x5E, (uint8_t[]){0x61}, 1, 0},
	{0x5F, (uint8_t[]){0x56}, 1, 0},
	{0x60, (uint8_t[]){0x4C}, 1, 0},
	{0x61, (uint8_t[]){0x4C}, 1, 0},
	{0x62, (uint8_t[]){0x40}, 1, 0},
	{0x63, (uint8_t[]){0x46}, 1, 0},
	{0x64, (uint8_t[]){0x31}, 1, 0},
	{0x65, (uint8_t[]){0x4A}, 1, 0},
	{0x66, (uint8_t[]){0x49}, 1, 0},
	{0x67, (uint8_t[]){0x49}, 1, 0},
	{0x68, (uint8_t[]){0x68}, 1, 0},
	{0x69, (uint8_t[]){0x55}, 1, 0},
	{0x6A, (uint8_t[]){0x5C}, 1, 0},
	{0x6B, (uint8_t[]){0x4E}, 1, 0},
	{0x6C, (uint8_t[]){0x49}, 1, 0},
	{0x6D, (uint8_t[]){0x3A}, 1, 0},
	{0x6E, (uint8_t[]){0x27}, 1, 0},
	{0x6F, (uint8_t[]){0x0C}, 1, 0},
	{0x70, (uint8_t[]){0x70}, 1, 0},
	{0x71, (uint8_t[]){0x61}, 1, 0},
	{0x72, (uint8_t[]){0x56}, 1, 0},
	{0x73, (uint8_t[]){0x4C}, 1, 0},
	{0x74, (uint8_t[]){0x4C}, 1, 0},
	{0x75, (uint8_t[]){0x40}, 1, 0},
	{0x76, (uint8_t[]){0x46}, 1, 0},
	{0x77, (uint8_t[]){0x31}, 1, 0},
	{0x78, (uint8_t[]){0x4A}, 1, 0},
	{0x79, (uint8_t[]){0x49}, 1, 0},
	{0x7A, (uint8_t[]){0x49}, 1, 0},
	{0x7B, (uint8_t[]){0x68}, 1, 0},
	{0x7C, (uint8_t[]){0x55}, 1, 0},
	{0x7D, (uint8_t[]){0x5C}, 1, 0},
	{0x7E, (uint8_t[]){0x4E}, 1, 0},
	{0x7F, (uint8_t[]){0x49}, 1, 0},
	{0x80, (uint8_t[]){0x3A}, 1, 0},
	{0x81, (uint8_t[]){0x27}, 1, 0},
	{0x82, (uint8_t[]){0x0C}, 1, 0},
	{0xE0, (uint8_t[]){0x02}, 1, 0},
    ...
    {0x29, (uint8_t[]){0x00}, 1, 20},
    {0x35, (uint8_t[]){0x00}, 1, 0},
#elif defined(CONFIG_ESP32P4_LCD_101)
    {0xE0, (uint8_t[]){0x00}, 1, 0},
    {0xE1, (uint8_t[]){0x93}, 1, 0},
    {0xE2, (uint8_t[]){0x65}, 1, 0},
    {0xE3, (uint8_t[]){0xF8}, 1, 0},
    ...
    {0x29, (uint8_t[]){0x00}, 1, 20},
    {0x35, (uint8_t[]){0x00}, 1, 0},
#elif defined(CONFIG_ESP32P4_LCD_40R)
    {0xE0, (uint8_t[]){0x00}, 1, 0},
    {0xE1, (uint8_t[]){0x93}, 1, 0},
    {0xE2, (uint8_t[]){0x65}, 1, 0},
    {0xE3, (uint8_t[]){0xF8}, 1, 0},
